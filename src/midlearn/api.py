...
class MIDRegressor(BaseEstimator, RegressorMixin):
    ...
    def fit(
        ...
        """
        Fits the MID model to the response y on predictors X.
...
class MIDExplainer(MIDRegressor, MetaEstimatorMixin):
    ...
    def fit(
        ...
        """
        Fits the surrogate MID model to the predictions of the estimator on X.
    ...
    def fidelity_score(
        ...
        """
        Calculates the fidelity of the surrogate model.
